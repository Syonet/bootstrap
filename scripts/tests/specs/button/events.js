(function( $ ) {
	...
	test( "toggle", 3, function() {
		this.button.syoButton( "option", "toggle", function( e, ui ) {
			...
			strictEqual( ui.active, true, "deve receber por parâmetro se o item está agora ativado ou desativado " +
					"(quando toggling = true)");
	...
	test( "beforeToggle", 3, function() {
		this.button.syoButton( "option", "beforeToggle", function( e, ui ) {
			...
			strictEqual( ui.active, false, "deve receber por parâmetro se o item estava ativado ou desativado " +
					"(quando toggling = true)" );
